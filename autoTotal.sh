...
python SIA.py Norway price
python SIA.py Norway cages
python SIA.py Norway localities
python SIA.py Norway numberSalmon
python SIA.py Norway biomass
python SIA.py Norway feedConsumption
python SIA.py Norway restock
...
python SIA.py Troms biomass
python SIA.py Troms feedConsumption
python SIA.py Troms restock
...
python SIA.py Finnmark biomass
python SIA.py Finnmark feedConsumption
python SIA.py Finnmark restock
...
python SIA.py Hordaland biomass
python SIA.py Hordaland feedConsumption
python SIA.py Hordaland restock
...
python SIA.py More_og_Romsdal biomass
python SIA.py More_og_Romsdal feedConsumption
python SIA.py More_og_Romsdal restock
...
python SIA.py Nordland biomass
python SIA.py Nordland feedConsumption
python SIA.py Nordland restock
...
python SIA.py Nord-Trondelag biomass
python SIA.py Nord-Trondelag feedConsumption
python SIA.py Nord-Trondelag restock
...
python SIA.py Rogaland_og_Agder biomass
python SIA.py Rogaland_og_Agder feedConsumption
python SIA.py Rogaland_og_Agder restock
...
python SIA.py Sogn_og_Fjordane biomass
python SIA.py Sogn_og_Fjordane feedConsumption
python SIA.py Sogn_og_Fjordane restock
...
python SIA.py Sor-Trondelag biomass
python SIA.py Sor-Trondelag feedConsumption
python SIA.py Sor-Trondelag restock
python SIA.py Sor-Trondelag withdrawals
python MIA.py Sor-Trondelag
